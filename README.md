...
| **Ollama**           | 완전 무료, 로컬 실행, 인터넷 불필요      | 품질 낮음, 도구 지원 제한적, 느림 | 실험, 비용 절감, 오프라인 작업 |
...
**도구 호출 지원**: Ollama는 `llama3.1:70b`, `llama3.1:8b`, `llama3.2`, `llama3.3`, `qwen2.5` 등의 모델에서 도구 호출을 지원합니다. 파일 읽기/쓰기, 검색, 포트레잇 생성 등 모든 기능을 사용할 수 있습니다.
